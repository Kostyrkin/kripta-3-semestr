...
class RSA:
    ...
    def Provreka(self, c_m, id_B):
        session_key = c_m['SessionKey']
        timestamp = c_m["TimeStamp"]
        type_hesh = c_m["DigitalSignature"]["DigestAlgorithmIdentifiers"]
        enc_M = c_m["DigitalSignature"]["SignerInfos"]["SignatureValue"]
        e = c_m["DigitalSignature"]["CertificateSet OPTIONAL"]["SubjectPublicKeyInfo"]["publicExponent"]
        n = c_m["DigitalSignature"]["CertificateSet OPTIONAL"]["SubjectPublicKeyInfo"]["N"]
        ...
        M_p = SHA.SHA().SHA_512(self.mod_text_in_bit(str({"IDUser": id_B, "SessionKey":session_key, "TimeStamp": timestamp})))
