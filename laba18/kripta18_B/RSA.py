...
class RSA:
    ...
    # Cipher RSA(Шифр RSA)
    def C_RSA(self, name_pk, name_zk):
        n = 100
        p = self.PMF(n, 100)
        q = self.PMF(n, 100)
        n = p * q
    ...
    def decoding(self, enc_M, p_k, type_k):
        if type_k == "zk":
            e = p_k["privateExponent"]
