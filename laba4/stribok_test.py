class heshf():
    ...
    def hesh_function(self, Mes):
        # этап 1
        h = "1"
        flag = input("Размер хеш функции:\n1)512-бит\n2)256-бит\n")
        if flag == "1":
            h = "0" * 512
        elif flag == "2":
            h = "00000001" * 64
        N = "0" * 512
        Z = "0" * 512
        # Для проверки юниикода
        M = self.mod_text_in_bit(Mes)
        # Для примеров с 16-ричным кодом
        # M = Mes
        while True:
            m = self.M_preobrz(M)
            if len(M) <= 512:
...
# Для примеров с 16-ричным кодом
'''
M_1 = "323130393837363534333231303938373635343332313039383736353433323130393837363534333231303938373635343332313039383736353433323130"
M_2 = "fbe2e5f0eee3c820fbeafaebef20fffbf0e1e0f0f520e0ed20e8ece0ebe5f0f2f120fff0eeec20f120faf2fee5e2202ce8f6f3ede220e8e6eee1e8f0f2d1202ce8f0f2e5e220e5d1"
obj = heshf()
HESH = obj.hesh_function(M_2)
print(HESH)
'''
...
if __name__ == '__main__':
    if input("Ввод:\n1)С консоли\n2)С файла\n") == "1":
        ...
        file = open(input("Введите местоположение файла:"), "r", encoding='utf-8')
        Mes = file.read()
    obj = heshf()
    HESH = obj.hesh_function(Mes)
    print(HESH)
