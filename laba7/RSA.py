...
class RSA:
    ...
    def Provreka(self, c_m):
        M_p = c_m["SignerInfos"]["UnsignedAttributes OPTIONAL"]["SET OF AttributeValue"]["User Signature"]
        enc_M = c_m["SignerInfos"]["UnsignedAttributes OPTIONAL"]["SET OF AttributeValue"]["Timestamp Center Data"]["Timestamp Center Signature"]
        e = c_m["SignerInfos"]["UnsignedAttributes OPTIONAL"]["SET OF AttributeValue"]["Timestamp Center Certificate"]["SubjectPublicKeyInfo"]["publicExponent"]
